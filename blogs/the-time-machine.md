...
Combining **six 2nd-dimensional** (planes object) results in a **3rd-dimensional object**—a space (which we can perceive). 
...
**6 × 2nd dimension** = 3rd dimension (a space, visible to us) \
...
In the XYZT world, a cube can move along the X, Y, and Z axes. For us, it's easy to imagine a cube moving in this 3D space. However, all dimensions—including the 4th—affect both the cube and the XYZ world. Since our brains can only perceive three dimensions at a time, how would a we see the cube moving through the 4th dimension?
...
We are always moving through time, advancing into the future moment by moment. Each instance of time, we enter a new, similar space. In this view, time is like layers of space stacked together. With every passing moment, we shift to a new space, a new universe, or even a new world. For every moment in time, there is a corresponding new space.
...
Imagine standing on a flat surface—your position along the X, Y, and Z axes stays the same. But if you stand on a frictionless slope, you’ll slide down forever without any effort. Now, think of time as an infinite slope: even when you’re not doing anything, you keep "falling" forward through time. The steepness of the slope could determine how fast time flows.

If time is like this slope, then all of existence—past, present, and future—might already be built into it, like layers stacked together. We’re just sliding through these pre-existing moments endlessly.
